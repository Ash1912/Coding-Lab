...
// time complexity O[n2] was written to find the result. It was observed that multiple results are possible
// and the very first fit found was displayed by the written UDF